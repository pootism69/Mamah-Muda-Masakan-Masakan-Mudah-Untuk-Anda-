...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <h3 class="text-center">Hasil pencarian untuk resep ayam goreng</h3>
            
            <div class="row mt-3 justify-content-center">
                <div class="col-lg-3 hovered-card">
                    <a href="info.html" class="card-link">
                        <div class="card mt-4">
                            <img src="img/Rectangle 10 (3).png" class="card-img-top" alt="...">
                            <div class="card-body">
                                <p class="card-text text-left">Lainnya</p>
                            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container text-center">
            <h2>Hasil pencarian akun untuk Ayam Goreng</h3>
        ...
        <div class="row justify-content-center">
            <div class="col-10 col-md-8 mx-auto my-4">
                <div class="mt-4">
                    <a href="resep_akun.html" class="account-box">
                        <img src="img/Vector (3).png" class="gambar-akun" alt="Avatar">
                        <div class="text-akun">Lainnya</div>
                    </a>
                </div>
